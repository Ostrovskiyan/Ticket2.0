...
public class Smsc_api{

	String SMSC_LOGIN    = "Ayliko";     
	String SMSC_PASSWORD = "a606e419c4581b33add2ad22ec7b89e9";  
	...
	public Smsc_api(String login, String password) {
		SMSC_LOGIN    = login;
		SMSC_PASSWORD = password;
	}

	public Smsc_api(String login, String password, String charset) {
		SMSC_LOGIN    = login;
		SMSC_PASSWORD = password;
		SMSC_CHARSET  = charset;
	}

	public Smsc_api(String login, String password, String charset, boolean debug) {
		SMSC_LOGIN    = login;
		SMSC_PASSWORD = password;
		SMSC_CHARSET  = charset;
		SMSC_DEBUG    = debug;
